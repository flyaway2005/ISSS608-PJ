...
-   **Machine Learning-Based Tender Categorization**: Uses text analysis to classify tenders, enabling grouped analysis by category to reveal agency procurement trends and supplier market dominance.

-   **Procurement Dashboard:** Visualizes procurement trends over time, revealing seasonal patterns, supplier shifts, and spending changes by tender type. It also analyzes market concentration and supplier dominance, highlighting procurement fairness and supplier competition within each category.

<!-- -->

-   **Network Analysis**: Uncovers agency-supplier relationships, identifying key players and procurement clusters while allowing filtering by tender category.
...
### Module 1. Machine Learning Based Tender Categorization
...
2.  **Contract concentration metrics** to assess agency reliance on specific suppliers.
3.  **Temporal market analysis** to track supplier entry/exit and market share shifts.
4.  **Award value distribution analysis** to highlight spending patterns and procurement diversity.

#### Specific insights: 

-   **Real-time Procurement Trends** : Monitor spending, contract awards, and supplier distribution over time.
...
-   **Market Share & Competitive Analysis** : Evaluate supplier dominance, competition, and procurement fairness across agencies.

### Module 3. G2B Procurement Network Analysis  
...
![](images/Network_1-01.png)

![](images/Network_2-01.png)
